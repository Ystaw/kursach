...
public class Message implements Serializable{  //процесс сохранения состояния объекта в последовательность байт
    ...
    private final static long serialVersionUID=1L;  //SerialVersionUID для реализации контроля версий
