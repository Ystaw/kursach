...
public class Rent implements Serializable, Identified<Integer> {
    ...
    public Rent(int idRent, int idOutlet, int idClient, Date start_date, Date finish_date, Outlets outlet) {
        ...
        this.start_date = start_date;
        this.finish_date = finish_date;
        Long days = (finish_date.getTime() - start_date.getTime())/8640000;  //Метод getTime ()  возвращает количество миллисекунд с 1 января 1970 года, 00:00:00 GTM
    ...
    public void setPayment(double costDay, int i) {
